...
public class MemberHandler{
  ...
  public void detail(Map<String,String> paramMap, PrintWriter out) throws Exception {
    ...
    if (member == null) {
      ...
      out.println("  </tr>");
      out.println("  <tr>");
      out.printf("    <th>이메일</th><td><textarea name='email' size='60'>%s</textarea></td>", member.email);
      out.println("  </tr>");
      out.println("  <tr>");
      out.println("    <th>암호</th><td><input name='password' type='password' size='20'></td>");
      out.println("  </tr>");
      out.println("  <tr>");
  ...
  public void delete(Map<String,String> paramMap, PrintWriter out) throws Exception {
    ...
    if (memberDao.delete(no) == 0) {
      ...
      out.println("<p>해당 번호의 회원을 삭제했습니다.</p>");
    }
  ...
  public void form(Map<String, String> paramMap, PrintWriter out) {
    ...
    out.println("<table border='1'>");
    out.println("  <tr>");
    out.println("    <th>이름</th><td><textarea name='name' type='text' size='60'></textarea></td>");
    out.println("  </tr>");
    out.println("  <tr>");
