...
CREATE TABLE ems_student (
  ...
  accoutn  VARCHAR(20)  NULL     COMMENT '계좌번호' -- 계좌번호
)
COMMENT '학생';
...
CREATE TABLE ems_position (
  ...
  title VARCHAR(50) NOT NULL COMMENT '직위' -- 직위
)
COMMENT '직위';
...
CREATE TABLE ems_center (
  ...
  ano      INTEGER      NOT NULL COMMENT '기본주소번호', -- 기본주소번호
  comip_id VARCHAR(20)  NOT NULL COMMENT '사업자번호', -- 사업자번호
...
CREATE TABLE ems_teacher (
  mno      INTEGER      NOT NULL COMMENT '회원번호', -- 회원번호
  bno      INTEGER      NOT NULL COMMENT '은행번호', -- 은행번호
  aacount  VARCHAR(20)  NOT NULL COMMENT '계좌번호', -- 계좌번호
